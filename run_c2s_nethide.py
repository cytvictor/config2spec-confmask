...
if __name__ == '__main__':
    ...
    network, netenv, waypoints = build_network(None, scenario_path, max_failures,
                                               waypoints_min, waypoints_fraction, is_nethide=True)
    ...
    pipeline = Pipeline(policy_db, sampler, dp_engine, netenv, None, window_size, network, debug)
